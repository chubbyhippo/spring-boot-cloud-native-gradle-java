...
import com.example.catalogservice.config.JdbcConfig;
...
class BookRepositoryJdbcTests {
    ...
    void shouldFindAllBooks() {
        var book1 = Book.of("1234561235", "Title", "Author", 12.90, "Chubby Hippo");
        var book2 = Book.of("1234561236", "Another Title", "Author", 12.90, "Chubby Hippo");
    ...
    void shouldFindBookByIsbnWhenExisting() {
        ...
        var book = Book.of(bookIsbn, "Title", "Author", 12.90, "Chubby Hippo");
    ...
    @Test
    void shouldFindBookByIsbnWhenNotExisting() {
        Optional<Book> actualBook = bookRepository.findByIsbn("1234561238");
        assertThat(actualBook).isEmpty();
    }

    @Test
    void shouldExistsByIsbnWhenExisting() {
        var bookIsbn = "1234561239";
        var bookToCreate = Book.of(bookIsbn, "Title", "Author", 12.90, "Chubby Hippo");
    ...
    @Test
    void shouldExistsByIsbnWhenNotExisting() {
